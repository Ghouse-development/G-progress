                            ...
                            <div className="flex items-start gap-0 relative">
                              ...
                              <div className="flex flex-col gap-0 relative">
                                ...
                                <div className="flex flex-col gap-0 relative">
                                  ...
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">ダッシュボード</div></div>
                                  ...
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">案件詳細（職種別ビュー）</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">タスクボード</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">職種別タスク一覧</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">遅延タスク</div></div>
                                  ...
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">粗利益管理</div></div>
                                  ...
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">カレンダー</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">組織管理</div></div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div className="flex flex-col gap-0 relative">
                            ...
                            <div className="flex items-start gap-0 relative">
                              ...
                              <div className="flex flex-col gap-0 relative">
                                ...
                                <div className="flex flex-col gap-0 relative">
                                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gray-500 dark:bg-gray-400"></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">商品マスタ</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">タスクマスタ</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">履歴ログ</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">システム管理</div></div>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col gap-0 relative">
                            ...
                            <div className="flex items-start gap-0 relative">
                              ...
                              <div className="flex flex-col gap-0 relative">
                                ...
                                <div className="flex flex-col gap-0 relative">
                                  <div className="absolute left-0 top-0 bottom-0 w-0.5 bg-gray-500 dark:bg-gray-400"></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">従業員管理</div></div>
                                  <div className="flex items-center gap-0"><div className="h-0.5 w-6 bg-gray-500 dark:bg-gray-400" style={{ marginTop: '12px' }}></div><div className="px-3 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded text-sm whitespace-nowrap">承認フロー</div></div>
                                </div>
                              </div>
                            </div>
                          </div>
