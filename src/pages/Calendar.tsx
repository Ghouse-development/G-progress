...
import { format, startOfMonth, endOfMonth, startOfWeek, endOfWeek, eachDayOfInterval, isSameDay, isSameMonth, addMonths, subMonths, differenceInDays } from 'date-fns'
                  ...
                  <div className="events">
                    ...
                    {calendarMode === 'tasks' && dayTasks.map((task) => {
                      ...
                      return (
                        ...
                        >
                          {customerName && <div className="text-base font-semibold mb-0.5">【{truncateTaskName(customerName, 8)}様】</div>}
