...
export const generateDemoEmployees = (): Employee[] => {
  return [
    ...
    { id: 'demo-emp-11', email: 'nara.design1@ghouse.com', last_name: '奈良', first_name: '設計一', department: '意匠設計', role: 'member', branch_id: '3', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { id: 'demo-emp-12', email: 'nara.const1@ghouse.com', last_name: '奈良', first_name: '工事一', department: '工事', role: 'member', branch_id: '3', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    ...
    { id: 'demo-emp-18', email: 'nishinomiya.design1@ghouse.com', last_name: '西宮', first_name: '設計一', department: '意匠設計', role: 'member', branch_id: '5', created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { id: 'demo-emp-19', email: 'nishinomiya.const1@ghouse.com', last_name: '西宮', first_name: '工事一', department: '工事', role: 'member', branch_id: '5', created_at: new Date().toISOString(), updated_at: new Date().toISOString() }
  ]
}
...
export const generateDemoProjects = (mode: Mode = 'admin'): Project[] => {
  ...
  const allProjects: Project[] = [
    // 本部（2件）
    { id: 'demo-project-1', customer_id: customers[0].id, product_id: products[0].id, product: products[0], contract_number: 'K2025-001', contract_date: format(addDays(baseDate, -150), 'yyyy-MM-dd'), floor_plan_confirmed_date: format(addDays(baseDate, -135), 'yyyy-MM-dd'), final_specification_meeting_date: format(addDays(baseDate, -120), 'yyyy-MM-dd'), construction_permission_date: format(addDays(baseDate, -100), 'yyyy-MM-dd'), construction_start_date: format(addDays(baseDate, -80), 'yyyy-MM-dd'), roof_raising_date: format(addDays(baseDate, -45), 'yyyy-MM-dd'), completion_inspection_date: format(addDays(baseDate, -10), 'yyyy-MM-dd'), handover_date: format(addDays(baseDate, -2), 'yyyy-MM-dd'), status: 'completed', progress_rate: 100, assigned_sales: employees[0].id, assigned_design: employees[1].id, assigned_construction: employees[2].id, sales_staff_id: employees[0].id, design_staff_id: employees[1].id, construction_staff_id: employees[2].id, sales_staff: employees[0], fiscal_year: '2025', contract_amount: 32000000, gross_profit: 6400000, total_floor_area: 35.5, solar_panel: true, solar_kw: 5.5, battery: true, ua_value: 0.46, bels: true, primary_energy_1: 45.2, primary_energy_2: 48.5, primary_energy_3: 52.0, c_value: 0.5, product_type: 'スタンダードプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { id: 'demo-project-2', customer_id: customers[1].id, product_id: products[1].id, product: products[1], contract_number: 'K2025-002', contract_date: format(addDays(baseDate, -120), 'yyyy-MM-dd'), floor_plan_confirmed_date: format(addDays(baseDate, -105), 'yyyy-MM-dd'), construction_permission_date: format(addDays(baseDate, -80), 'yyyy-MM-dd'), construction_start_date: format(addDays(baseDate, -60), 'yyyy-MM-dd'), roof_raising_date: format(addDays(baseDate, -25), 'yyyy-MM-dd'), status: 'construction', progress_rate: 70, assigned_sales: employees[0].id, assigned_design: employees[1].id, assigned_construction: employees[2].id, sales_staff_id: employees[0].id, design_staff_id: employees[1].id, construction_staff_id: employees[2].id, sales_staff: employees[0], fiscal_year: '2025', contract_amount: 28000000, gross_profit: 5600000, total_floor_area: 32.0, solar_panel: false, battery: false, ua_value: 0.52, bels: false, primary_energy_1: 58.3, primary_energy_2: 61.2, primary_energy_3: 65.0, c_value: 0.6, product_type: 'エコノミープラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },

    // 豊中（2件）
    { id: 'demo-project-3', customer_id: customers[2].id, product_id: products[2].id, product: products[2], contract_number: 'K2025-003', contract_date: format(addDays(baseDate, -90), 'yyyy-MM-dd'), floor_plan_confirmed_date: format(addDays(baseDate, -75), 'yyyy-MM-dd'), construction_permission_date: format(addDays(baseDate, -50), 'yyyy-MM-dd'), construction_start_date: format(addDays(baseDate, -30), 'yyyy-MM-dd'), status: 'construction', progress_rate: 40, assigned_sales: employees[5].id, assigned_design: employees[6].id, assigned_construction: employees[7].id, sales_staff_id: employees[5].id, design_staff_id: employees[6].id, construction_staff_id: employees[7].id, sales_staff: employees[5], fiscal_year: '2025', contract_amount: 38000000, gross_profit: 7600000, total_floor_area: 40.0, solar_panel: true, solar_kw: 6.5, battery: true, ua_value: 0.42, bels: true, primary_energy_1: 40.8, primary_energy_2: 43.2, primary_energy_3: 46.5, c_value: 0.4, product_type: 'プレミアムプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { id: 'demo-project-4', customer_id: customers[3].id, product_id: products[3].id, product: products[3], contract_number: 'K2025-004', contract_date: format(addDays(baseDate, -70), 'yyyy-MM-dd'), floor_plan_confirmed_date: format(addDays(baseDate, -60), 'yyyy-MM-dd'), construction_permission_date: format(addDays(baseDate, -40), 'yyyy-MM-dd'), status: 'post_contract', progress_rate: 25, assigned_sales: employees[5].id, assigned_design: employees[6].id, assigned_construction: employees[7].id, sales_staff_id: employees[5].id, design_staff_id: employees[6].id, construction_staff_id: employees[7].id, sales_staff: employees[5], fiscal_year: '2025', contract_amount: 25000000, gross_profit: 5000000, total_floor_area: 28.5, solar_panel: false, battery: false, ua_value: 0.55, bels: false, primary_energy_1: 62.5, primary_energy_2: 65.8, primary_energy_3: 68.0, c_value: 0.7, product_type: 'コンパクトプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },

    // 奈良（2件）
    { id: 'demo-project-5', customer_id: customers[4].id, product_id: products[0].id, product: products[0], contract_number: 'K2025-005', contract_date: format(addDays(baseDate, -50), 'yyyy-MM-dd'), floor_plan_confirmed_date: format(addDays(baseDate, -35), 'yyyy-MM-dd'), status: 'post_contract', progress_rate: 15, assigned_sales: employees[9].id, assigned_design: employees[10].id, sales_staff_id: employees[9].id, design_staff_id: employees[10].id, sales_staff: employees[9], fiscal_year: '2025', contract_amount: 35000000, gross_profit: 7000000, total_floor_area: 38.0, solar_panel: true, solar_kw: 6.0, battery: false, ua_value: 0.48, bels: true, primary_energy_1: 47.5, primary_energy_2: 50.2, primary_energy_3: 53.8, c_value: 0.55, product_type: 'スタンダードプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { id: 'demo-project-6', customer_id: customers[5].id, product_id: products[4].id, product: products[4], contract_number: 'K2025-006', contract_date: format(addDays(baseDate, -30), 'yyyy-MM-dd'), floor_plan_confirmed_date: format(addDays(baseDate, -20), 'yyyy-MM-dd'), status: 'post_contract', progress_rate: 10, assigned_sales: employees[9].id, assigned_design: employees[10].id, sales_staff_id: employees[9].id, design_staff_id: employees[10].id, sales_staff: employees[9], fiscal_year: '2025', contract_amount: 42000000, gross_profit: 8400000, total_floor_area: 45.0, solar_panel: true, solar_kw: 7.0, battery: true, ua_value: 0.40, bels: true, primary_energy_1: 38.5, primary_energy_2: 41.0, primary_energy_3: 44.2, c_value: 0.35, product_type: 'プレミアムプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },

    // 京都（2件）
    { id: 'demo-project-7', customer_id: customers[6].id, product_id: products[1].id, product: products[1], contract_number: 'K2025-007', contract_date: format(addDays(baseDate, -20), 'yyyy-MM-dd'), status: 'post_contract', progress_rate: 5, assigned_sales: employees[12].id, sales_staff_id: employees[12].id, sales_staff: employees[12], fiscal_year: '2025', contract_amount: 29000000, gross_profit: 5800000, total_floor_area: 33.0, solar_panel: false, battery: false, ua_value: 0.53, bels: false, primary_energy_1: 60.2, primary_energy_2: 63.5, primary_energy_3: 66.8, c_value: 0.65, product_type: 'スタンダードプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { id: 'demo-project-8', customer_id: customers[7].id, product_id: products[2].id, product: products[2], contract_number: 'K2025-008', contract_date: format(addDays(baseDate, -10), 'yyyy-MM-dd'), status: 'post_contract', progress_rate: 3, assigned_sales: employees[12].id, sales_staff_id: employees[12].id, sales_staff: employees[12], fiscal_year: '2025', contract_amount: 27000000, gross_profit: 5400000, total_floor_area: 30.0, solar_panel: true, solar_kw: 5.0, battery: false, ua_value: 0.50, c_value: 0.60, product_type: 'エコノミープラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },

    // 西宮（2件）
    { id: 'demo-project-9', customer_id: customers[8].id, product_id: products[3].id, product: products[3], contract_number: 'K2025-009', contract_date: format(addDays(baseDate, -5), 'yyyy-MM-dd'), status: 'post_contract', progress_rate: 1, assigned_sales: employees[16].id, sales_staff_id: employees[16].id, sales_staff: employees[16], fiscal_year: '2025', contract_amount: 36000000, gross_profit: 7200000, total_floor_area: 39.0, solar_panel: true, solar_kw: 6.2, battery: true, ua_value: 0.45, c_value: 0.50, product_type: 'スタンダードプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
    { id: 'demo-project-10', customer_id: customers[9].id, product_id: products[0].id, product: products[0], contract_number: 'K2025-010', contract_date: format(addDays(baseDate, -2), 'yyyy-MM-dd'), status: 'post_contract', progress_rate: 1, assigned_sales: employees[16].id, sales_staff_id: employees[16].id, sales_staff: employees[16], fiscal_year: '2025', contract_amount: 31000000, gross_profit: 6200000, total_floor_area: 34.0, solar_panel: false, battery: false, ua_value: 0.51, c_value: 0.62, product_type: 'コンパクトプラン', exclude_from_count: false, created_at: new Date().toISOString(), updated_at: new Date().toISOString() }
  ]
